...
<head>
	...
	<script type="text/javascript">
		function addEmployee() {
			...
			$.post("${pageContext.request.contextPath}/employee/addSchoolkeleader",$("#employeeForm").serialize(),
					function (data) {
						if (data == "FAIL"){
							alert("员工添加失败！");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="main_locbg font2"><img src="${pageContext.request.contextPath}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：领导信息管理  &gt; 添加科级干部领导</td>
