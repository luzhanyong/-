...
<meta content="" name="author" />
	...
	<link rel="ico" href="${pageContext.request.contextPath}/安阳工学院.ico">
...
<body style="font-family: 微软雅黑 ">
	<div class="page-lock a">
<%--	<div id="login-box" class="page-lock">--%>
		<div class="page-logo" style="margin-bottom: 2px">
			<h2 class="brand" href="login.html"
				style="font-size: 22px; color: white;"> 领导干部信息管理
			</h2>
		</div>
					...
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-user" style="margin: 6px 2px 4px 10px ;"></i>
								<input
									class="m-wrap placeholder-no-fix" id="input" type="text" placeholder="帐号"
									id="loginname" name="loginname" autocomplete="new-password" value="${loginname}">
							</div>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left" style="color: white">
								<i class="icon-lock" style="margin: 6px 2px 4px 10px"></i>
								<input
									class="m-wrap placeholder-no-fix" type="password" id="inputs"
...
<%--					style="margin-left: 20px">--%>
			<button type="submit" class="button" id="login-submit-btn">
				登录
			</button>
		</div>
		</form>
